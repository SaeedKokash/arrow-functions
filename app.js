...
//Refractored constructor to arrow function but as we know its not possible
...
//  "this" is an object that we created in the constructor Student. is bound to an element (object) that we created in the constructor.

// 2. What is "this" when joe.scopeArrow() is invoked?
//  "this" is an object of the console window. is not bound to any element, it is bound to the whole window

// 3. Explain why "this" is different when an arrow function is used.
//  because "this" in a normal function bounds to an element that we create in a constuctor, but when an arrow function is used; it bounds 
//  to the window of the console